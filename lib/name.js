...
exports.get1 = function(property) {
    if(undefined === property) property = properties[random.int(0, 4)];

    var temp = names[property];
    var idx = random.int(0, temp.length - 1);
    return temp[idx];
};

exports.get2 = function(property) {
    if(undefined === property) {
        var idx = random.int(0, combination2Max - 1);
...
exports.get3 = function(property) {
    if(undefined === property) {
        var idx = random.int(0, combination3Max - 1);
...
exports.get4 = function(property) {
    return exports.get3() + exports.get1();
};

exports.get = function() {
    var temp = random.int(1, 1000);
    if(temp <= 250) return exports.get1();
    if(temp <= 500) return exports.get2();
    if(temp <= 750) return exports.get3();
    return exports.get4();
};
